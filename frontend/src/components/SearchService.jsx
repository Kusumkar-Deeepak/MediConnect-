...
const SearchSection = () => {
  ...
  const defaultHospitals = [
    ...
    },
    {
      ...
      doctorImage:
        "https://sunshinehospital.co/assets/images/Gallery/Hospital-Front-Main.jpg",
      languagesSpoken: "English, Hindi",
      degree: "MBBS, MS",
    },
    {
      ...
      doctorImage:
        "https://safartibbi.com/wp-content/uploads/2024/05/apollo.jpg",
    ...
    },
    {
      ...
      openingHours: "9:00 AM - 6:00 PM",
      doctorImage:
        "https://www.guptasen.com/wp-content/uploads/2024/03/Artteza-Towers-Santacruz-West.webp",
    ...
    },
    {
      ...
      doctorImage:
        "https://www.puneinsight.com/wp-content/uploads/2020/06/care-main.jpg",
      languagesSpoken: "English, Marathi",
      degree: "MBBS, DCH",
    },
    {
      ...
      doctorImage:
        "https://images1-fabric.practo.com/5555cd34516ec6512bd43d9caa6e02c990b0a82652dca.jpg",
    ...
    },
    {
      ...
      doctorImage:
        "https://www.bizzbuzz.news/h-upload/2023/11/25/1820020-fortis.webp",
    ...
    },
    {
      ...
      doctorImage:
        "https://d35oenyzp35321.cloudfront.net/Max_Super_Speciality_Hospital_Shalimar_Bagh_jpg_5c1758d700.jpg",
      languagesSpoken: "English, Hindi",
      degree: "MBBS, MS ENT",
    },
    {
      ...
      doctorImage:
        "https://cdn.hexahealth.com/Image/cb8ab721-b3fe-4270-908d-0e61d2d9a7de.jpg",
      languagesSpoken: "English, Hindi",
    ...
    },
    {
      ...
      doctorImage:
        "https://images1-fabric.practo.com/rainbow-children-s-multispecialty-clinic-mumbai-1483344465-586a0a5160419.JPG",
      languagesSpoken: "English, Marathi",
      degree: "MBBS, DCH",
    },
    {
    ...
    },
    {
      ...
      openingHours: "8:00 AM - 4:00 PM",
      doctorImage:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Narayana_Institute_of_Cardiac_Sciences%2C_Bangalore%2C_Karnataka%2C_India_%282014%29.jpg/640px-Narayana_Institute_of_Cardiac_Sciences%2C_Bangalore%2C_Karnataka%2C_India_%282014%29.jpg",
      languagesSpoken: "English, Kannada",
    ...
    },
    {
      ...
      doctorImage:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsz-nXUx7s6u6ApkleAKLuJKsZBzJoKoKR-w&s",
    ...
    },
    {
      ...
      openingHours: "9:00 AM - 5:00 PM",
      doctorImage:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLMFRi94FMQFAA657L5Mt-jTH48Nj_Y7emuw&s",
      languagesSpoken: "English, Tamil",
    ...
    },
    {
      ...
      doctorImage:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRpV87VafapRkvWeymOQjF9PW-FDQ6bwOnHA&s",
      languagesSpoken: "English, Kannada",
    ...
    },
    {
      ...
      openingHours: "10:00 AM - 7:00 PM",
      doctorImage:
        "https://images1-fabric.practo.com/saket-city-hospital-delhi-1475413314-57f10542d8dc1.jpg",
      languagesSpoken: "English, Hindi",
    ...
    },
    {
      ...
      openingHours: "9:00 AM - 6:00 PM",
      doctorImage:
        "https://content3.jdmagicbox.com/comp/rangareddy/x3/040pxx40.xx40.191215215505.c2x3/catalogue/cure-hospitals-pocharam-rangareddy-multispeciality-hospitals-2j6vjak0oh.jpg",
      languagesSpoken: "English, Telugu",
    ...
    },
    {
      ...
      openingHours: "8:00 AM - 6:00 PM",
      doctorImage:
        "https://images1-fabric.practo.com/practices/679642/shanthi-hospital-chennai-666e4e8a5a276.png",
      languagesSpoken: "English, Tamil",
    ...
    },
    {
      ...
      openingHours: "9:00 AM - 5:00 PM",
      doctorImage:
        "https://cdn.worldclinics.net/clinic/large/jpg/vasundhara-hospital-1.jpg",
      languagesSpoken: "English, Marathi",
  ...
  const handleSearch = () => {
    ...
    if (!cityToSearch) {
      ...
      setFilteredHospitals(
        isLoggedIn ? allHospitals : defaultHospitals.slice(0, 3)
      );
      return;
    }
